...
musicControlBtn.addEventListener("click", function() {
    // 将文字复制到剪贴板
    navigator.clipboard.writeText("圣诞快乐，圣诞抽奖码：20231225，").then(function() {
        console.log('圣诞快乐 已复制到剪贴板');
    }, function(err) {
...
element.innerHTML = "MERRY CHRISTMAS!";
...
element.innerHTML = "<br />    圣诞快乐"+"<br />    祝天天开心，不必无语凝噎";//p2文本修改在这里！
var element = document.getElementById("p1");
element.innerHTML =" <br />    By_Cheng";//p1文本修改在这里！
